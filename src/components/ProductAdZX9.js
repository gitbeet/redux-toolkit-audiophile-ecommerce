...
export default function ProductAdZX9() {
  return (
    <div className="product-ad-square">
      <img
        className="image-mobile image-product-ad-square"
        src={productImageMobile}
        alt="zx9 speaker"
      />
      <img
        className="image-tablet image-product-ad-square"
        src={productImageTablet}
        alt="zx9 speaker"
      />
      <img
        className="image-desktop image-product-ad-square"
      ...
      <img
        ...
        src={patternCircles}
        alt="circle pattern behind speaker"
      />
      <h1 className="product-ad-square-name">zx9 speaker</h1>
      <p className="text-center product-ad-square-description">
        Upgrade to premium speakers that are phenomenally built to deliver truly
        remarkable sound.
      </p>
      <div className="button-ad-square">
        <Link to="/headphones/6">
