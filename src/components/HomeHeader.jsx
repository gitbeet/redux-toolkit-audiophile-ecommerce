  ...
  return (
    <div className="home-header">
      ...
      <div className="header-text">
        <p className="overline header-text-muted header-new-product">
          new product
        </p>
      ...
      <img
        className="image-mobile header-image"
        src={imageHeaderMobile}
        alt="header"
      />
      <img
        className="image-tablet header-image"
        src={imageHeaderTablet}
        alt="header"
      />
      <img
        className="image-desktop header-image"
